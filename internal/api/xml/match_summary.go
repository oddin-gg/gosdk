...
// CommonSportEventStatus — scalar attributes are POINTERS so absence
// stays distinguishable from zero (see the feed-side SportEventStatus
// note; same partial-update erasure class).
